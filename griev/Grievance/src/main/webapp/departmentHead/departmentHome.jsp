	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-lg-auto">
				...
				<li class="nav-item">
				<a class="nav-link  mr-3 text-white" href="<%=request.getContextPath()%>/DepartmentHeadController/reopenComplain">Reopen
						Complain<span class="badge badge-light"><c:out
								value="${count}"></c:out></span>
				</a>
				</li>
				<li class="nav-item"><a class="nav-link mr-3 text-white"
					href="<%=request.getContextPath()%>/DepartmentHeadController/reminderList">Reminder<span
						class="badge badge-light"><c:out value="${reminderCount}"></c:out></span></a>
						</li>
...
<!-- center text -->
		...
		<div class=" text-center mt-3 center_text">
			<h3>
				<c:out value="${ListOfComplain[0].deptName}"></c:out>
				Department
			</h3>
		</div>
		...
		<div class="container">
			<table class="table table-striped mt-4">
				...
				<tbody>
					...
					<c:forEach var="Complain" items="${ListOfComplain}">
								...
								<div class="modal fade" id="exampleModalCenter" tabindex="-1"
									...
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form method="post"
													action="<%=request.getContextPath()%>/DepartmentHeadController/submitRemark">

													<div class="form-group">
														<label for="citizen-id" class="col-form-label">Complain
															ID:</label> <input type="text" class="form-control" name="compId"
															style="width: 15rem">
													</div>
...
<!-- Copyright -->
			...
			<div class="footer-copyright text-center py-3" style="background-color: #2F363F">© 2020 Copyright: 
			<a
					href="https://www.cybage.com/worldwide-locations/india/gandhinagar"
					class="text-white"> www.cybage.com
					</a>
			</div>
