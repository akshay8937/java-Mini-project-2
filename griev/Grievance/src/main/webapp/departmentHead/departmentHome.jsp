...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ml-lg-auto">
				...
				< <li class="nav-item">
                    <a class="nav-link  mr-3 text-white" href="<%=request.getContextPath()%>/DepartmentHeadController/reopenComplain">Reopen Complain<span class="badge badge-light"><c:out value="${count}"></c:out></span></a>
                </li> 
	...
	<div>
		...
		<div class=" text-center mt-3 center_text">
			<h3><c:out value="${ListOfComplain[0].deptName}"></c:out> Department</h3>
		</div>
								...
								<td>
									...
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form method="post" action="<%=request.getContextPath()%>/DepartmentHeadController/submitRemark">
